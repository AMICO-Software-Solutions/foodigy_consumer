...
import 'package:foodigy/styles/custom_otp_style.dart';
import 'package:foodigy/utilities/const_color.dart';



class OTPCustomeTextField extends StatefulWidget {
  ...
  @override
  _OTPCustomeTextFieldState createState() => _OTPCustomeTextFieldState();
}

class _OTPCustomeTextFieldState extends State<OTPCustomeTextField> {
...
class OtpFieldController {
  late _OTPCustomeTextFieldState _otpTextFieldState;

  void setOtpTextFieldState(_OTPCustomeTextFieldState state) {
