...
class ChefActiveOrderViewSummary extends StatefulWidget {
  String? orderType;
 ...
 ChefActiveOrderViewSummary(
  ...
  @override
  State<ChefActiveOrderViewSummary> createState() => _ChefActiveOrderViewSummaryState();
}

int start = 120;
int current = 120;

class _ChefActiveOrderViewSummaryState extends State<ChefActiveOrderViewSummary> {
  ActiveOrderController activeController = Get.put(ActiveOrderController());
  ChefProfileController chefProfileController =  Get.put(ChefProfileController());
  DateTime? orderPlacedDate = DateTime.now();
  DateTime? orderAcceptedDate = DateTime.now();
  DateTime? orderPickUpDate = DateTime.now();
 DateTime? takeawayOrderPickUpDate = DateTime.now();
  ...
  void _load() async {
    ...
    Timer(const Duration(seconds: 0), () {
     ...
     Timer(const Duration(seconds: 0), () {
      String productTime = DateFormat('HH:mm a').format(takeawayOrderPickUpDate!);
      takeAwayOrderdeliveryTime(productTime);
    });
    Timer(const Duration(seconds: 0), () {
  ...
  //get assign and pickup value
 List<Map<String,dynamic>> my_List =[];

  void getAssign(){
    for (var i = 0;  i <= activeController.activeOrder!.data![widget.index].deliveryType!.length; i++) {
      my_List.add({
         "deliveryTypeId": activeController.activeOrder!.data![widget.index].deliveryType![i].deliveryTypeId,
                    "orderId": activeController.activeOrder!.data![widget.index].deliveryType![i].orderId,
                    "trackingId": activeController.activeOrder!.data![widget.index].deliveryType![i].trackingId,
                    "traceId": activeController.activeOrder!.data![widget.index].deliveryType![i].traceId,
                    "trackingurl": activeController.activeOrder!.data![widget.index].deliveryType![i].trackingurl,
                    "deliveryStatus": activeController.activeOrder!.data![widget.index].deliveryType![i].deliveryStatus,
                    "deliveryStatusTimeStamp":activeController.activeOrder!.data![widget.index].deliveryType![i].deliveryStatusTimeStamp,
                    "deliveryPersonName": activeController.activeOrder!.data![widget.index].deliveryType![i].deliveryPersonName,
                    "deliveryPersonContactNumber": activeController.activeOrder!.data![widget.index].deliveryType![i].deliveryPersonContactNumber,
                    "cancelledBy": activeController.activeOrder!.data![widget.index].deliveryType![i].cancelledBy,
                    "remarks": activeController.activeOrder!.data![widget.index].deliveryType![i].remarks,
                    "createdAt": activeController.activeOrder!.data![widget.index].deliveryType![i].createdAt,
                    "updatedAt": activeController.activeOrder!.data![widget.index].deliveryType![i].updatedAt,
                    "createdBy": activeController.activeOrder!.data![widget.index].deliveryType![i].createdBy,
                    "updatedBy": activeController.activeOrder!.data![widget.index].deliveryType![i].updatedBy
 ...
 return value= my_List.where((e) => e["deliveryStatus"]!.contains("PICKEDUP")||e["deliveryStatus"]!.contains("ASSIGNED")).toList();
}
...
String? takeAwayOrderDeliveryTime='';
  ...
  void initState() {
    ...
    print(placedTime);
      Timer(const Duration(seconds: 0),(){
        ...
        takeawayOrderPickUpDate = activeController
                  .activeOrder!.data![widget.index].readyForDeliverTime
                  .toString() ==
              'null'
          ? DateTime.parse("2022-12-29T07:36:00.819Z")
    ...
    Timer(const Duration(seconds: 0), () {
      ...
      orderPickUpDate = activeController
              ...
              'null'
          ? DateTime.parse(activeController
              .activeOrder!.data![widget.index].deliveryType![0].deliveryStatusTimeStamp.toString())
          : DateTime.parse(activeController
              .activeOrder!.data![widget.index].deliveredTime
              .toString());
  ...
  Widget build(BuildContext context) {
    ...
    List<StepperData> stepperData = [
      ...
      activeController.activeOrder!.data![widget.index].orderStatus ==
          ...
          : StepperData(),
      activeController.activeOrder!.data![widget.index].orderStatus ==
              "ACCEPTED" && my_List.any((my_List) => my_List["deliveryStatus"] =="ASSIGNED")?
              StepperData(
              title: StepperText(
          ...
          : StepperData(),
      // activeController.activeOrder!.data![widget.index].orderStatus ==
      //         "ACCEPTED" &&  activeController.activeOrder!.data![widget.index].deliveryType!.contains({"deliveryStatus": "PICKEDUP",})
     activeController.activeOrder!.data![widget.index].orderStatus == "ACCEPTED" &&my_List.any((my_List) => my_List["deliveryStatus"] =="PICKEDUP")
          ? StepperData(
              title: StepperText(
                "Order is on the way",
                textStyle: FoodigyTextStyle.addTocartStyle,
    ...
    List<StepperData> takeAwayStepper = [
      ...
      activeController.activeOrder!.data![widget.index].orderStatus ==
          ...
          ? StepperData(
              ...
              subtitle: StepperText(
                  "${DateFormat.yMMMd().format(takeawayOrderPickUpDate!).toString()}, ${ takeAwayOrderDeliveryTime.toString()}"),
              iconWidget: Container(
                padding: const EdgeInsets.all(8),
                decoration: const BoxDecoration(
                    color: Colors.green,
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                widget.orderType.toString() == "TAKEAWAY"
                    ? Container()
                    :(isDataLoading== false? (value.isEmpty ? Container(): asignContainer()) : Container()),
                   // : asignCheckContainer(),
                SizedBox(
                  height: 5,
                ),
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                      Text(value[0]['deliveryPersonName'].toString()),
                                        Row(
                                          children: [
                                            Icon(
                                              MdiIcons.phone,
                                            ...
                                            Text(
                                             value[0]["deliveryPersonContactNumber"].toString(),
                                              style: FoodigyTextStyle
                                                  .smallGreyTextStyle,
                                            )
                                          ],
  ...
  //     return StepperData();
  //   } else {
  //     for (var i = 0; i <=   activeController
  //                 .activeOrder!.data![widget.index].deliveryType!.length; i++) {
  ...
  void takeAwayOrderdeliveryTime(String? productTime) {
    setState(() {
      //  print("product time");
      //   print(productTime);
      ...
      //  print("am values");
       ...
       //   print("more then 60 $valu");
          ...
          ///  print("$valu $seco $third");
             ...
             takeAwayOrderDeliveryTime = "${valuTwo.toString()}:${seco.toString()} $third";
          } else {
            valu = valu - 12;
          //  print("$valu $seco PM");
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
             takeAwayOrderDeliveryTime = "${valuTwo.toString()}:${seco.toString()} PM";
          }
        } else {
          if (valu < 12) {
          //  print("$valu $second $third");
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
             takeAwayOrderDeliveryTime =
                "${valuTwo.toString()}:${second.toString()} $third";
          } else {
            valu = valu - 12;
          ///  print("$valu $second PM");
            String valuTwo = valu.toString() == "0" ? "12" : valu.toString();
            takeAwayOrderDeliveryTime = "${valuTwo.toString()}:${second.toString()} PM";
          }
        }
      } else {
        // print("pm value");
        ...
        if (int.parse(second.toString()) >= 60) {
         ...
         takeAwayOrderDeliveryTime= "${valuTwo.toString()}:${seco.toString()} PM";
             ...
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
         takeAwayOrderDeliveryTime= "${valuTwo.toString()}:${seco.toString()} AM";
          ...
          takeAwayOrderDeliveryTime= "${valuTwo.toString()}:${second.toString()} PM";
             ...
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
         takeAwayOrderDeliveryTime = "${valuTwo.toString()}:${second.toString()} AM";
        //    print("$valu $second PM");
          }
        }
      }
      ...
      if (third == "AM") {
        ...
        if (int.parse(second.toString()) >= 60) {
          ...
          if (valu < 12) {
            print("$valu $seco $third");
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderAcceptedTIme = "${valuTwo.toString()}:${seco.toString()} $third";
          } else {
            valu = valu - 12;
            print("$valu $seco PM");
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderAcceptedTIme = "${valuTwo.toString()}:${seco.toString()} PM";
          }
        } else {
          if (valu < 12) {
            print("$valu $second $third");
        ...
        if (int.parse(second.toString()) >= 60) {
          ...
          if (valu <= 24) {
            ...
            orderAcceptedTIme = "${valuTwo.toString()}:${seco.toString()} PM";
             ...
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderAcceptedTIme = "${valuTwo.toString()}:${seco.toString()} AM";
            print("$valu $second AM");
          }
        } else {
          if (valu < 24) {
            ...
            orderAcceptedTIme = "${valuTwo.toString()}:${second.toString()} PM";
             ...
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderAcceptedTIme = "${valuTwo.toString()}:${second.toString()} AM";
            print("$valu $second PM");
          }
        }
      }
      ...
      if (third == "AM") {
        ...
        if (int.parse(second.toString()) >= 60) {
          ...
          if (valu < 12) {
            print("$valu $seco $third");
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderPickedTIme = "${valuTwo.toString()}:${seco.toString()} $third";
          } else {
            valu = valu - 12;
            print("$valu $seco PM");
          ...
          if (valu < 12) {
            print("$valu $second $third");
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderPickedTIme = "${valuTwo.toString()}:${second.toString()} $third";
          } else {
            valu = valu - 12;
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            print("$valu $second PM");
            orderPickedTIme = "${valuTwo.toString()}:${second.toString()} PM";
          }
        }
      } else {
        print("pm value");
        ...
        if (int.parse(second.toString()) >= 60) {
          ...
          if (valu <= 24) {
            ...
            orderPickedTIme = "${valuTwo.toString()}:${seco.toString()} PM";
             ...
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderPickedTIme = "${valuTwo.toString()}:${seco.toString()} AM";
            print("$valu $second AM");
          }
        } else {
          if (valu < 24) {
            ...
            orderPickedTIme = "${valuTwo.toString()}:${second.toString()} PM";
             ...
             String valuTwo =  valu.toString()=="0"?"12": valu.toString();
            orderPickedTIme = "${valuTwo.toString()}:${second.toString()} AM";
            print("$valu $second PM");
          }
        }
      }
