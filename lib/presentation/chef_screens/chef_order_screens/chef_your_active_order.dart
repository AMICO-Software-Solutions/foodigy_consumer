...
class ChefYourOrderListDesign extends StatefulWidget {
  final String? date;
  final ChefOrderModel? activeOrder;
  final int index;
  const ChefYourOrderListDesign(
      {super.key, this.date, this.activeOrder, required this.index});

  @override
  State<ChefYourOrderListDesign> createState() => _ChefYourOrderListDesignState();
}

class _ChefYourOrderListDesignState extends State<ChefYourOrderListDesign> {
