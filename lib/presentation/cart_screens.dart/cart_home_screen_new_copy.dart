...
//                                             child: Text(
//                                               "Based on your items, delivery is available at ${cartTimer.allTimes[0]}",
...
//                                                                         String second = newValue.toString().substring(
//                                                                             newValue.toString().indexOf(':') +
//                                                                                 1,
//                                                                             newValue.toString().indexOf(' '));
//                                                                         int data =
...
//                                                               print(deliveryDate);
//                                                               print(totalValue);
//                                                               print(cartListController.cartList!.data!.cartValue.toString());
//                                                               print(currentUserId);
//                                                               print( cartListController.cartList!.data!.cartDetails![0].providerId.toString(),);
//                                                               couponController.getCoupons(
//                                                                  cartValue: totalValue.toString(),
//           consumerId: currentUserId,
//           chefId: cartListController.cartList!.data!.cartDetails![0].providerId
...
//                                                               ),
//                                                               Text(
//                                                                   'Delivery date : ${DateFormat.yMEd().format(DateTime.now())}',
//                                                                   style: FoodigyTextStyle
//                                                                       .smallTextStyle),
//                                                               GetBuilder<
//                                                                       CartCountController>(
...
//                                                                       )
//                                                                     : Text(
//                                                                         '\u{20B9} ${totalCostWithCouponTax.toString()}',
//                                                                         style: TextStyle(
//                                                                             color: Colors.black,
//                                                                             //  fontFamily: 'Poppins',
//                                                                             fontWeight: FontWeight.bold),
...
//                                                                                 totalCost: totalCostWithCouponTax == 0 ? totalAmountWithTax.toString() : totalCostWithCouponTax.toString(),
